...
# Festlegen von Konstanten und Verzeichnissen
# Die Verzeichnisse müssen Sie evtl. anpassen
batch_size = 20
img_height = 256
img_width = 256
...
#region Model
model_name="ConvNextTiny"+'_'+Dataset 

base_model = tf.keras.applications.ConvNeXtTiny(input_shape=img_shape,
                                               include_top=False,
                                               weights='imagenet',
                                               include_preprocessing = True)


print(f' Length base: {len(base_model.layers)}')
